...
import { usePatchResource } from "@/composables/useResource";
...
const { data, error, isLoading, patchData } = usePatchResource<Station>(
  "/api/v1/playlists/" + params.playlistId
);
  ...
  >
    <FormField v-slot="{ componentField }" name="name">
      <FormItem class="mt-6">
        ...
        <FormDescription class="text-xs text-left">
          This is the name of the playlist. It will be used to identify the
    ...
    <FormField v-slot="{ componentField }" name="description">
      <FormItem class="mt-6">
        ...
        <FormMessage class="text-left" />
        <FormDescription class="text-xs text-left">
          Provide a brief description of the playlist. Maximum 200 characters.
        </FormDescription>
      </FormItem>
    </FormField>
